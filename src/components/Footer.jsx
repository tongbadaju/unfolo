    ...
    return (
        ...
        <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <ul className="mt-9 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                ...
                <li>
                    <a className="text-gray-700 cursor-pointer transition hover:text-[var(--color-primary)]" onClick={() => navigate('/tutorial')}> Tutorial </a>
                </li>
            </ul>
            ...
            <li>
                <a
                    href="https://www.linkedin.com/in/tusharrai818/"
                    rel="noreferrer"
                    target="_blank"
                ...
                >
                    ...
                    <path
                        ...
                        0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 
                        1.75-.78 1.75-1.75 1.75zm13.5 11.3h-3v-5.6c0-1.34-.03-3.07-1.87-3.07-1.87 
                        0-2.16 1.46-2.16 2.97v5.7h-3v-10h2.88v1.37h.04c.4-.75 
                        1.38-1.54 2.85-1.54 3.05 0 3.61 2.01 3.61 4.62v5.55z"
                    />
                    </svg>
                </a>
                </li>
            ...
            <li>
                <a
                href="https://www.instagram.com/tongbadaju/"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75"
                >
            ...
            <li>
                <a
                href="https://www.github.com/tongbadaju/"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75"
                >
            ...
            <p className="mt-8 text-center text-xs text-gray-400">
                &copy; {new Date().getFullYear()} Unfolo. All rights reserved.
            </p>
        </div>
        </footer>
    )
